...
- **Subinterpreters** - in-process isolation with a per-interpreter GIL; somewhere between threads and processes.
- **Freethreaded Python** - removes the GIL; threads scale for CPU-bound work, but ecosystem support is still catching up.


Subinterpreters seem like the stop-gap approach (and a side-effect of the GIL removal efforts). 

Free-threaded Python <!--TODO: Add future plans-->
