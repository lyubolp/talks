...
- **Freethreaded** Python removes the GIL and enables threads scale for CPU-bound work. However the ecosystem support is still catching up. While introduced in Python3.13, the plan for making the GIL opt-in has no set timeline.
